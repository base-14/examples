...
# Slim 3 + MongoDB + OpenTelemetry API Testing Script
...
echo "=== Slim 3 + MongoDB API Testing Script ==="
echo "Target: $API_URL"
echo ""
...
ARTICLE1_RESPONSE=$(curl -s -X POST "$API_URL/api/articles" \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"title":"Getting Started with Slim 3","description":"A guide to Slim 3","body":"Slim 3 is a micro-framework for PHP.","tagList":["slim","php","tutorial"]}')

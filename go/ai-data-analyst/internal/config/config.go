...
func Load() *Config {
	return &Config{
		...
		LLMModelCapable:    envOr("LLM_MODEL_CAPABLE", "qwen3.5:9B"),
		LLMModelFast:       envOr("LLM_MODEL_FAST", "qwen3.5:9B"),
		FallbackProvider:   envOr("FALLBACK_PROVIDER", "ollama"),
		FallbackModel:      envOr("FALLBACK_MODEL", "qwen3.5:9B"),

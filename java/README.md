...
| [micronaut-postgres](./micronaut-postgres) | Micronaut 4.8 + Java 25 + PostgreSQL 18 with OTel Java Agent, distributed tracing, notification microservice, and custom metrics |

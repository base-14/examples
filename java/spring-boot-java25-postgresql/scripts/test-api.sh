...
# Spring Boot Java 25 + PostgreSQL API Testing Script
...
echo -e "${YELLOW}=== Spring Boot Java 25 + PostgreSQL API Tests ===${NC}"
echo ""
...
STATUS=$(curl -s -o /dev/null -w "%{http_code}" -X DELETE "$BASE_URL/users/999999")

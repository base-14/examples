...
echo "$SERVICES" | grep -q "micronaut-articles" && check "service: micronaut-articles" 0 || check "service: micronaut-articles" 1
echo "$SERVICES" | grep -q "micronaut-notify" && check "service: micronaut-notify" 0 || check "service: micronaut-notify" 1
...
echo "Check your Scout dashboard for traces from 'micronaut-articles' service."

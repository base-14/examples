      ...
      children: [
          ...
          trailing: Switch.adaptive(
            ...
            onChanged: (value) {
              OTelConfig.interactionTracker
                  .trackButtonClick(context, 'setting_marketing_emails');
        ...
        ListTile(
          ...
          trailing: Switch.adaptive(
            ...
            onChanged: (value) {
              OTelConfig.interactionTracker
                  .trackButtonClick(context, 'setting_rate_reminder');
        ...
        ListTile(
          ...
          trailing: Switch.adaptive(
            ...
            onChanged: (value) {
              OTelConfig.interactionTracker
                  .trackButtonClick(context, 'setting_background_refresh');
        ...
        ListTile(
          ...
          trailing: Switch.adaptive(
            ...
            onChanged: (value) {
              OTelConfig.interactionTracker
                  .trackButtonClick(context, 'setting_location_songs');
        ...
        ListTile(
          ...
          trailing: Switch.adaptive(
            ...
            onChanged: (value) {
              OTelConfig.interactionTracker
                  .trackButtonClick(context, 'setting_auto_cast');
        ...
        ListTile(
          ...
          trailing: Switch.adaptive(
            ...
            onChanged: (value) {
              OTelConfig.interactionTracker
                  .trackButtonClick(context, 'setting_find_friends');
              setState(() => switch7 = value);
            },
          ),
        ),
      ],

...
import 'otel/rum_rage_click_detector.dart';
...
class _SongsTabState extends State<SongsTab> {
  ...
  void _togglePlatform(BuildContext context) {
    OTelConfig.interactionTracker
        .trackButtonClick(context, 'toggle_platform');
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              OTelConfig.interactionTracker
                  .trackButtonClick(context, 'refresh_songs');
              await _androidRefreshKey.currentState!.show();
            },
          ),
          IconButton(
            icon: const Icon(Icons.shuffle),
            onPressed: () => _togglePlatform(context),
          ),
        ],
      ),
